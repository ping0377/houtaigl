<template>
        <div>
            ...
            <el-table :data="formlist">
                <!-- <el-table-column label="产品编号" prop="total"></el-table-column>
                <el-table-column label="产品名称" prop="totalNum"></el-table-column> -->
                <el-table-column label="产品总数" prop="totalNum"></el-table-column>
            </el-table>
            <el-table :data="buylist">
                <el-table-column property="ProductCode" label="产品编号" width="120"></el-table-column>
                <el-table-column property="name" label="产品名称" width="120"></el-table-column>
                <el-table-column property="num" label="库存数"></el-table-column>
            </el-table>
        ...
        export default {
            ...
            methods: {
                handleCurrentChange(val){
                    ...
                    axios.get(`api/main/report/stock/main?time=${this.time}&page=${val}`, {
                ...
                getforms() {  //选择年月进行查询
                    this.formlist.splice(0, this.formlist.length)
                    axios.get(`api/main/report/stock/main?time=${this.time}`, {
                        headers: { Authorization: cookie.get("token") }
                    }).then(resp => {
                        let res = resp.data;
                        this.formlist.push(res);
