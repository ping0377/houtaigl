<template>
  <div>
    ...
    <el-table :data="formlist">
      <el-table-column label="出库单据数" prop="total"></el-table-column>
    ...
    <el-table :data="buylist">
      ...
      <el-table-column property="stockTime" label="出库日期" width="120"></el-table-column>
...
export default {
  ...
  methods: {
    handleCurrentChange(val) {
      ...
      axios
        .get(`api/main/report/outstock/main?time=${this.time}&page=${val}`, {
